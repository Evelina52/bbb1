...
SQLALCHEMY_DATABASE_URL = "mysql+pymysql://isp_p_Baskova:12345@77.91.86.135/isp_p_Baskova"
...
# Удалена неправильная fake_decode_token

# Получение текущего активного пользователя по токену
...
# исправленный контроллер /users/me
